...
/**
 * Fast UUID provider using {@link ThreadLocalRandom}.
 * Not cryptographically secure, but avoids contention across threads
 * and is significantly faster than {@link UUID#randomUUID()}.
 */
